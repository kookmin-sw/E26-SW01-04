...
- 프로젝트 진행 ✔️  
  - 과거에 사람들이 상상한 미래
  그림에서 상상한 태양광 발전, 전기자동차, 원격수업, 화상통화, 각종 전자기기와 자동화 기술 등은 현재 대부분 실제로 구현되어 있다. 특히 스마트폰이나 화상통화, 전자기기 등은 일상생활에 매우 널리 보급되었고, 전기자동차와 태양광 발전 역시 점차 사용이 확대되고 있다. 반면 달나라 여행은 아직 일반인이 쉽게 이용할 정도로 상용화되지 않았다. 이를 통해 과거의 미래에 대한 상상 중 상당 부분이 현실이 되었지만, 기술이 존재하는 것과 일상적으로 보편화되는 것에는 차이가 있다는 점을 알 수 있었다.
  - 그들이 만들어가는 세상
  - 우리가 상상한 미래
  - 우리가 그리는 미래 그리고 나
